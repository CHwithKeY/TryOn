 ...
 */
public abstract class UnableCouponRycAdapter extends BaseCouponRycAdapter {

    public UnableCouponRycAdapter(ArrayList<ObjectCoupon> objectList) {
        super(objectList);
    }

    @Override
    public DataViewHolder onCreateDataViewHolder(ViewGroup parent) {
        View view = View.inflate(parent.getContext(), R.layout.recycler_shoe_general_unable_item, null);
