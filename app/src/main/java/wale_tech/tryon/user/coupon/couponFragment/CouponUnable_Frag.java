...
import wale_tech.tryon.user.coupon.UnableCouponRycAdapter;

/**
 * Created by KeY on 2016/11/6.
 */

public class CouponUnable_Frag extends Base_Frag {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_coupon_unable_layout, container, false);
    }
    ...
    private void varInit() {
        ...
        couponAction.getCoupon(CouponAction.COUPON_UNABLE);
    }

    private void setupEmptyRecyclerView(ArrayList<ObjectCoupon> couponList) {
        BaseCouponRycAdapter adapter = new UnableCouponRycAdapter(couponList) {
            @Override
        ...
        coupon_rv = (EmptyRecyclerView) getActivity().findViewById(R.id.coupon_unable_rv);
